...
public class MethodAssociationVisitor extends MethodVisitor {
	...
	public MethodAssociationVisitor(int api, IRelationshipManager relationshipManager, String className, String arguments) {
		super(api);
	...
	public MethodAssociationVisitor(int api, MethodVisitor decorated, IRelationshipManager relationshipManager, String className, String arguments) {
		super(api, decorated);
		_relationshipManager = relationshipManager;
		_className = className;
		_arguments = arguments;
...
//	}
	...
	public void visitVarInsn(int code, int var) {
		...
		if (var == 1) {
			...
			for (String arg : args) {
				_relationshipManager.addRelationshipEdge(_className, arg.trim(), RelationshipType.USES);
			}
		}
	}
}
