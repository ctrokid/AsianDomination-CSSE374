...
public class DesignParser {
	...
	public static final String[] CLASSES = // PackageInspector.getClasses(sourceDir,
											// new File(sourceDir));
	...
	public static void main(String[] args) throws IOException {
		// IProjectModel model = new ProjectModel(CLASSES,
		...
		// targetClasses[i], relationshipManager);
		// ClassVisitor fieldVisitor = new ClassFieldVisitor(Opcodes.ASM5,
		// decVisitor, targetClasses[i], relationshipManager);
		// ClassVisitor methodVisitor = new ClassMethodVisitor(Opcodes.ASM5,
		// fieldVisitor, targetClasses[i], relationshipManager);
		//
		...
		// LaunchDiagramGenerator.RunGVEdit(asmOutputPath, dotOutputPath,
		// DiagramFileExtension.PDF);
	}
}
