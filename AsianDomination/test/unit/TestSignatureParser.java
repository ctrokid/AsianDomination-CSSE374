...
public class TestSignatureParser {
	...
	public void integerParsingTest(){
		ArrayList<String> param = SignatureParser.getParams("(I)V", true);
	...
	public void hashMapParsingTest(){
		ArrayList<String> param = SignatureParser.getParams("(Ljava/util/HashMap;)Ljava/util/Collection", true);
		assertEquals(1,param.size());
